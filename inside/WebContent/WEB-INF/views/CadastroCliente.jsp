            ...
            <div class="container-fluid pdd-30-lg-b pdd-30-md-b">
              ...
              <div class="mat-card-kit ">
                ...
                <div class="row">
                  ...
                  <a href="listar_clientes" class='col-md-2 col-lg-2 col-sm-2 col-xs-2'><i class="back fa fa-chevron-circle-left fa-3x"></i></a> 
                        ...
                        <div class="row">
                          <div class="col-lg-6 col-md-6 pdd-30-lg-t pdd-30-md-t pdd-15-lg-l">
                            <div class="col-lg-3 col-md-3">
                              <h5 for="cliente" class="text-gray">Cliente</h5>
                            </div>
