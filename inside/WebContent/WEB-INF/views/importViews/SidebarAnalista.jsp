					...
					<div class="col-md-10 col-lg-10 col-lg-offset-1 col-md-offset-1 pdd-15-md-t pdd-15-lg-t pdd-15-md-b pdd-15-lg-b">
						...
						<div class="row">
							<div class="col-md-12 col-lg-12">
								<h4 class="text-white text-center">Olá, ${funcionario.nome}</h4>
							</div>
						</div>
						<div class="row">
							<div class="col-md-12 col-lg-12">
...
<!-- 						<div class="row">
							<div class="col-md-10 col-lg-10">
								<a href="#"><h5 class="text-white text-center"><i class='fa fa-edit'></i> Editar perfil</h5></a>
							</div>
						</div> -->
					</div>
				</div>
		...
		<div class="menu pdd-30-md-t pdd-30-lg-t">
			...
			<li><a href="agenda" class="text-white"> <i
					class="fas fa-calendar text-white pdd-15-lg-r" aria-hidden="true"
